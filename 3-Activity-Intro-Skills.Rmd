...
Take the tibble from problem 5. Create a new column that is the Range of the PET (max PET - min PET). Then get rid of the max RBI and min RBI columns so the tibble just has columns for State, mean PET, and PET range.
