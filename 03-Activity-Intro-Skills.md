...
subject: Courseware
doi: https://doi.org/10.4211/hs.9260d1f2959e4a128e95adc756df8ad3
venue:
  title: View Resource on HydroShare
  url: https://hydroshare.org/resource/9260d1f2959e4a128e95adc756df8ad3/
github: https://github.com/VT-Hydroinformatics/3-Activity-Intro-Skills
downloads:
  - file: 03-Activity-Intro-Skills.md
  - file: 03-Activity-Intro-Skills.pdf
---
...
precip (PPTAVG_BASIN) and the percentage of snow (SNOW_PCT_PRECIP).

Create a new column in the dataset called SNOW_AVG_BASIN and make it
...
something to geom_bar() to use it for a 2 variable plot… check out the
ggplot cheatsheet or do a quick internet search.
